  ...
  data () {
    return {
      list1: [{
        ...
        img_1: '/static/img/index-service-1.png'
      }, {
        id: 2,
        h2_1: '知识产权服务',
        p_1: '知识产权战略咨询、知识产权申请与管理、知识产权运营',
        img_1: '/static/img/index-service-2.png'
      }, {
        id: 3,
        h2_1: '科技咨询服务',
        p_1: '科技战略研究咨询、科技项目申报辅导、科技项目管理服务',
        img_1: '/static/img/index-service-3.png'
      }],
      list2: [{
        id: 1,
        h2_1: '科技项目管理',
        p_1: '科技项目评审、可行性评估、项目监理、绩效评价',
        img_1: '/static/img/index-service-4.png'
      }, {
        id: 2,
        h2_1: '创新成果服务',
        p_1: '科技成果评价、科技成果登记、技术交易中介',
        img_1: '/static/img/index-service-5.png'
      }, {
        id: 3,
        h2_1: '创业孵化服务',
        p_1: '孵化器园区运营、孵化天使基金投资、创业企业管理外包',
        img_1: '/static/img/index-service-6.png'
      }],
      list3: [{
        id: 1,
        h2_1: '科技金融服务',
        p_1: '投资顾问、科技保险、企业融资服务',
        img_1: '/static/img/index-service-7.png'
      }, {
        id: 2,
        h2_1: '职业教育培训',
        p_1: '高职教育优化服务、企业人力资源顾问服务、企业内训',
        img_1: '/static/img/index-service-8.png'
      }, {
        id: 3,
        h2_1: '财税顾问服务',
        p_1: '新四板上市服务、尽职调查、报表审计、代理记账服务',
        img_1: '/static/img/index-service-9.png'
      }]
    }
  },
  mounted () {
